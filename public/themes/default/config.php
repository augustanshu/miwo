    ...
    */
    ...
    'events' => array(
        ...
        'beforeRenderTheme' => function($theme)
        {
			 ...
			 //$theme->asset()->usePath()->add('scrolex', 'js/jquery.scrollex.min.js');
			// $theme->asset()->usePath()->add('scrollify', 'js/jquery.scrollify.min.js');
		     //$theme->asset()->usePath()->add('easing', 'js/jquery.easing.1.3.js');
			  $theme->asset()->usePath()->add('fullpage', 'js/jquery.fullPage.js');
        ...
        'beforeRenderLayout' => array(
            ...
            {
				 $theme->asset()->usePath()->add('pullpage', 'css/jquery.fullPage.css');
